...
<div class="container">
	...
	<form:form method="post" modelAttribute="dynAdminInfo">
		...
		<fieldset class="form-group">
			<form:label path="newValue">New Value</form:label>
			<form:input path="newValue" type="text" class="form-control"
				required="required" />
			<form:errors path="newValue" cssClass="text-warning" />
		</fieldset>
		...
		<fieldset class="form-group">
			<form:label path="saveToFile">Save To Property Files Too?</form:label>
			<form:checkbox path="saveToFile" class="form-control" value="Yes" />
			<form:errors path="saveToFile" cssClass="text-warning" />
		</fieldset>
		...
		<button type="submit" class="btn btn-success">Set New Value</button>
