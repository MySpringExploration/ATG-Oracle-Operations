/* 
 *  @Warning: Your use of this software is completely at your sole risk. 
 * 	Author of this software is not responsible for any loss/damage to 
 * 	data/database assests by the usage of this software. However end users 
 * 	are welcome to report any issues/bugs they faced while using this software.
 *  
 *	@Description: This script file serves the purpose of validation at client side 
 *	as well as few image maipulation tasks required else where in the application.
 *	
 *	@Author: Vamsi B (mailto: vamsi.borra@gmail.com)
 *	@Date Created: Early Jan 2004
 *	@Date Last Modified: 19 Sep 2004
 */
...
function changeStyle(index, len) {
	for(var i=0; i <= len ; i++) {
		document.getElementById('tree_node_' + i).className = 'node';
	}
	
	document.getElementById('tree_node_' + index).className = 'nodeSel';
}