 ...
 * 
 */
public class CallableComponetValueSetter implements Callable<String> {
	...
	public CallableComponetValueSetter(PopulateDetailsHelper populateDetailsHelper, String hostURL, String component,
			String property, String newValue, boolean saveFile) {
		super();
	...
	public String call() throws UnsupportedEncodingException, IOException, ClientProtocolException {
		...
		logger.info("Begin : CallableComponetValueSetter --> call()");
		...
		logger.info("End : CallableComponetValueSetter --> call()");
		return errors;
	}
