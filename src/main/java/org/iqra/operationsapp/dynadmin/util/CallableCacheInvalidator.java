...
public class CallableCacheInvalidator implements Callable<String> {
	...
	public CallableCacheInvalidator(PopulateDetailsHelper populateDetailsHelper, String hostURL,
	...
	public String call() throws UnsupportedEncodingException, IOException, ClientProtocolException {
		...
		logger.info("Begin : CallableCacheInvalidator --> call()");
		...
		try {
			...
			url = "http://" + hostURL + "/dyn/admin/nucleus/" + repositoryName.trim() + "/";

			HttpPost httpost = new HttpPost(url);

			List<BasicNameValuePair> nvps = new ArrayList<BasicNameValuePair>();
			nvps.add(new BasicNameValuePair("invokeMethod", "invalidateCaches"));
			...
			System.out.println(" Cache Invalidated for  : " + url);
		...
		logger.info("End : CallableCacheInvalidator --> call()");
		return errors;
	}
